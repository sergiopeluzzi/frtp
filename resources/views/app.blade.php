                ...
                <div id="footer" class="container">
                    ...
                    <div class="row 150%">
                        <div class="6u 12u(mobile)">
                            <!-- Contact Form -->
                            <section>
                                {!! Form::open(['route' => 'login.montaEmailContato', 'method' => 'post', 'id' => 'formContato']) !!}
                                    <div class="row 50%">
                                        <div class="6u 12u(mobile)"><input type="text" name="NOME" id="contact-name" placeholder="Nome" /></div>
                                        <div class="6u 12u(mobile)"><input type="text" name="EMAIL" id="contact-email" placeholder="Email" /></div>
                                    </div>
                                    <div class="row 50%">
                                        <div class="12u"><textarea name="MESSAGE" id="contact-message" placeholder="Mensagem" rows="4"></textarea></div>
                                    </div>
                                    <div class="row">
                                        <div class="12u">
                                            <ul class="actions">
